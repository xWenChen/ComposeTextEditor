...
import com.wellcherish.compose.texteditor.base.config.ConfigManager
import com.wellcherish.compose.texteditor.base.constants.FileChangeType
import com.wellcherish.compose.texteditor.base.constants.SaveState
...
import com.wellcherish.compose.texteditor.base.utils.content
import com.wellcherish.compose.texteditor.base.utils.generateContentId
import com.wellcherish.compose.texteditor.base.utils.getFileName
import com.wellcherish.compose.texteditor.base.utils.getFileTitle
...
import com.wellcherish.texteditor.utils.autoSave
...
class EditorViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private fun getOrCreateFileData(
        ...
        if (dbData == null || dbData.title.isNullOrEmpty() || dbData.title != title) {
            ...
            // 数据保存到db
            FileDataSource.updateOrInsertDbData(dbData)
